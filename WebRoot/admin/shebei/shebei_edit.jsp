		...
		<div class="container-layout">
			<div class="panel gao-form-bg">
				...
				<div class="panel-body">
					<form onsubmit="return true;" class="form-x radius-big" action="<%=path %>/shebei_update.action" name="gaoform" method="post">
								...
								<div class="form-group" id="f_1510851941628">
									...
									<div class="field">
									 <input type="text" class="input" id="jiage" name="jiage" maxlength="8" value="${requestScope.Shebei.jiage}" data-validate="required:请填写数字,age:请输入数字" placeholder="输入年龄">
									</div>
								</div>													
								<div class="form-group" id="f_1510851941628">
									<div class="label">
