		...
		<div class="container-layout">
			<div class="panel gao-form-bg">
				...
				<div class="panel-body">
					<form onsubmit="return true;" class="form-x radius-big" action="<%=path %>/admin_save.action" name="gaoform" method="post">
								...
								<div class="form-group" id="f_1510851941628">
									...
									<div class="field">
								        	<input class="input" id="userpwd" name="userpwd" maxlength="50" value="" data-validate="required:请填写内容" placeholder="输入内容" type="text">
									</div>
								</div>							
								<div class="form-group" id="f_1510851941628">
									<div class="label">
