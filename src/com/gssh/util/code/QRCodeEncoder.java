...
public class QRCodeEncoder {
    ...
    public static void main(String[] args) throws Exception{
      ...
      //  String imgPath = "";
        ...
        encoder.encoderQRCode("dsfsdfsdf", "D:\\tomcat7\\webapps\\phonemm\\upload//1541227453817.jpg", "png", "UTF-8", 4, 20, null, null, 6, null, null);
        //加上logo
      ...
      //  encoder.encoderQRCode(content, imgPath, "gif", "utf-8", 5, 10, Color.BLACK, Color.WHITE, 4, "",null); //"d:/test2.gif"
      //  encoder.encoderQRCode(content, imgPath, "jpg", "utf-8", 5, Color.BLUE, Color.WHITE, Color.RED,null, "",1,2);
      ...
      //  BufferedImage bk = ImageIO.read(bkfile);
       ...
       // boolean ret = encoder.encoderQRCode(content, imgPath, null, null, 9, Color.BLUE, null, null, null, null, 0, 1); //size=9-11
    ...
    public static void getQRCode(String content, String imgPath){
        //生成普通二维码：名片
        QRCodeEncoder encoder = new QRCodeEncoder();
    	encoder.encoderQRCode(content, imgPath, "jpg", "UTF-8", 4, 20, null, null, 6, null, null);
    }
     ...
     * @param border 边框大小（默认10）  margin：二维码外边距（像素，注意校验，不能超过width和height的值）
     ...
     * 
     * 
     * encoder.encoderQRCode(content, imgPath, "jpg", "utf-8", 5, Color.Blue, Color.WHITE, Color.RED, null,null,null);
     */
